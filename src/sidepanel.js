...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // TODO: manual URL input - check valid URL
  // function showManualError(show = true) {
  //   const errorMsg = document.getElementById('manual-error');
  //   if (!errorMsg) return;
  ...
  // document.getElementById('manual-extract-btn').addEventListener('click', () => {
  //   const url = document.getElementById('manual-url-input').value.trim();
  //   const isValid = url.startsWith('https://tickettool.xyz/transcript');
  
  //   if (!isValid) {
  //     showManualError(true); // show error
  //   } else {
  //     showManualError(false); // hide error
